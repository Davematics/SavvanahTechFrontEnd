<template>
  <div class="min-h-screen flex items-center justify-center bg-gray-50 px-4">
    <div class="max-w-md w-full">
      <h2 class="ext-center text-xl font-bold text-gray-800 mb-6">Practical Assessment | 
SavannahTech</h2>
      <h2 class="text-center  font-bold text-gray-800 mb-6">Sign in to your dashboard</h2>
